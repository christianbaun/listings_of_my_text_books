// title:        Listing_9.6_tcp_socket_client.c
...
// compile with: gcc Listing_9.6_tcp_socket_client.c -o Listing_9.6_tcp_socket_client
...
//               ./Listing_9.6_tcp_socket_client <ip-address> <portnumber>
